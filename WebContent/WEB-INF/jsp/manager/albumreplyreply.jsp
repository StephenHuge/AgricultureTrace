...
<div class="ibody">
  <header>
    ...
    <%@ include file="managernavi.jsp" %>
     ...
     <article>
    <h2 class="about_h">You now as:<a href="http://localhost:8080/SpringMVC_Blog/manager/index">Index</a>>><a href="http://localhost:8080/SpringMVC_Blog/manager/album">Album</a></h2>
    <div class="template">
      ...
      <ul class="pl_n">
       <sf:form method="post" modelAttribute="albumreplyreply">
        <dl>
          <dt>
        <%--   <img src="<%=request.getContextPath()%>${albumreplyreply.messagephoto}"> --%>
          <img src="<%=request.getContextPath()%>/Resources/images/004.jpg">
          </dt>
          <dt> </dt>
          <dd>${albumreplyreply.messagename}
            <time>${albumreplyreply.mdate}</time>
            &nbsp;&nbsp;&nbsp;&nbsp;<a href="${albumreplyreply.messageid}/messagedelete">Delete</a>
          </dd>
          <dd><a href="#">${albumreplyreply.messagecontent }</a></dd>
