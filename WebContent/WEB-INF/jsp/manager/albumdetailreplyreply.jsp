...
<div class="ibody">
  <header>
    ...
    <div class="template">
      ...
      <ul class="pl_n">
       <sf:form method="post" modelAttribute="photoreplyreply">
        <dl>
          <dt>
          <img src="<%=request.getContextPath()%>${photoreplyreply.messagephoto}">
          <img src="<%=request.getContextPath()%>/Resources/images/002.jpg">
          </dt>
          <dt> </dt>
          <dd>${photoreplyreply.messagename}
            <time>${photoreplyreply.mdate}</time>
            &nbsp;&nbsp;&nbsp;&nbsp;<a href="${photoreplyreply.messageid}/photodelete">Delete</a>
          </dd>
          <dd><a href="#">${photoreplyreply.messagecontent }</a></dd>
