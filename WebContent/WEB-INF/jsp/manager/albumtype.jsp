...
<body>
	<div class="ibody">
		...
		<article>
			<h2 class="about_h">
				You now as:<a href="http://localhost:8080/SpringMVC_Blog/manager/index">Index</a>>><a href="http://localhost:8080/SpringMVC_Blog/manager/album">Album
								</a><a href="http://localhost:8080/SpringMVC_Blog/manager/addalbum">Add album</a>
			</h2>
			<div class="template">
				<h3>
